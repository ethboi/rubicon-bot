...
import type { RubiconMarket, RubiconMarketInterface } from "../RubiconMarket";
...
export class RubiconMarket__factory {
  static readonly abi = _abi;
  static createInterface(): RubiconMarketInterface {
    return new utils.Interface(_abi) as RubiconMarketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RubiconMarket {
    return new Contract(address, _abi, signerOrProvider) as RubiconMarket;
  }
}
